...
author_name_list=['Young','Lynn','dachui','zhe','zhen']
article_title_list=['Django 教程','Python 教程','HTML教程']
...
def create_authors():
	for author_name in author_name_list:
		...
		author.email='%s@yongxuetang.com' % (author.addr)
		author.save()
